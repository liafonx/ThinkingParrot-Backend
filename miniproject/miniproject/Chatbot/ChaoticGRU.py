...
if __name__ == "__main__":
    ...
    CGRU = ChaoticGRU(inputSize=1536, hiddenSize=1536, Lee=Lee, chaotic=True, bidirection=True)
    # CGRU2 = ChaoticGRU(inputSize=1536, hiddenSize=1536, Lee=Lee, chaotic=True, bidirection=True)
    # Test the Bi-GRU.
    x = torch.randn([10, 128, 1536])
    print(x.shape)
    output, h = CGRU(x)
    print(output.shape)
    print(h.shape)
    # output2, h2 = CGRU2(x, initStates=h)
    # print(output2)
    # print(h2)
    ...
    #
    # # Create the GRU unit.
    # CGRU = ChaoticGRU(inputSize=46, hiddenSize=10, chaotic=False, bidirection=False)
    # # Test the GRU.
    # x = torch.randn((32, 10, 46))
    # print(x.shape)
    # output, h = CGRU(x)
